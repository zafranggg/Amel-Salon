    ...
    <div class="content">
        ...
        <div class="container wide-content mt-4" id="contentLangsung">
            ...
            <div class="border border-danger rounded p-3 mb-4 bg-light-pink">
                ...
                <small class="text-muted"> Ini adalah daftar jam kosong dan padat pada hari ini</small>
    ...
    <div class="modal" id="modalTransaksi">
        <div class="modal-dialog">
            <form method="POST" id="bookingForm" action="{{ route('jadwalbooking.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content p-4" style="background-color: white; width: 100%;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border-pink" name="nama_pelanggan" placeholder="Masukkan nama pelanggan..." value="{{ $customer->nama_pelanggan}}" required>
                    ...
                    <div class="modal-footer border-0 justify-content-between">
                        <button type="button" class="btn btn-secondary" onclick="closeModal2()">Kembali</button>
