...
<div class="brand d-flex justify-content-between align-items-center mb-3">
  ...
  <button id="toggleSidebar" class="btn btn-sm btn-outline-secondary">
    ...
    <a class="nav-link {{ request()->is('jadwal-booking') ? 'active' : '' }}" href="{{ url('/jadwal-booking') }}">
      <i class="bi bi-calendar-check"></i><span class="link-text">Jadwal Treatment</span>
    </a>
    <a class="nav-link {{ request()->is('treatment-pelanggan') ? 'active' : '' }}" href="{{ route('treatmentPelanggan.index') }}">
      <i class="bi bi-scissors"></i><span class="link-text">Treatment Salon</span>
    </a>
    </a>
    <a class="nav-link {{ request()->is('riwayat-transaksi') || request()->is('daribooking') || request()->is('menunggu_jadwal') ? 'active' : '' }}" href="/riwayat-transaksi">
    ...
    <!--<a class="nav-link {{ request()->is('kelola_informasi_salon') ? 'active' : '' }}" href="/kelola_informasi_salon">
      <i class="bi bi-info-circle"></i><span>Kelola Informasi Salon</span>
        ...
        <div class="footer-links">
          ...
          <a class="nav-link {{ request()->is('pelanggan-profil') ? 'active' : '' }}" href="/pelanggan-profil"><i class="bi bi-person"></i><span class="link-text">Profil</span></a>
