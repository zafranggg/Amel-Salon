    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-4" style="background-color: white; width: 100%;">
            ...
            <div class="modal-body">
                ...
                <p><strong><span class="text-danger">Sisa Bayar:</span></strong> <span class="text-danger fw-bold">Rp
                        500.000</span></p>
                ...
                <form id="formTransaksi" class="card-info mx-auto" style="max-width: 700px;">
                    <div class="mb-3">
                        ...
                        <div class="form-check mt-2">
                            ...
                            <label class="form-check-label" for="pelangganBaru">Tambahkan Pelanggan Baru (Belum
                                Punya Akun)</label>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <input type="number" id="harga" class="form-control" placeholder="Harga"
                                style="width: 130px;">
                            <button type="button" class="btn btn-success" onclick="tambahTreatment()"><i
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-pink"><i class="bi bi-save"></i> Simpan
                            Transaksi</button>
                    </div>
                </form>
            </div>
