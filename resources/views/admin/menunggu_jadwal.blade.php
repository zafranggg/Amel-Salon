...
@section('content')
@section('nama')
    <h3 class="mt-4">Daftar Boking</h3>
...
<div class="card-info">
    ...
    @endif
    <h5 class="text-center text-danger fw-bold">Daftar Jadwal Booking Yang </h5>
    <p class="text-center">Lihat seluruh jadwal booking yang belum dilakukan.</p>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                              <div class="d-flex gap-2">
                                ...
                                <!-- Tombol Konfirmasi -->
                                <form method="POST" action="{{ route('booking.jadwal', $booking->id_booking) }}">
                                  @csrf
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center">Belum ada booking yang menunggu jadwal</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
...
<div id="modalDetail{{ $booking->id_booking }}" class="modal">
  <div class="modal-content">
    ...
    <div class="actions">
      ...
      <form action="{{ route('booking.jadwal', $booking->id_booking) }}" method="POST" style="display:inline;">
        @csrf
      ...
      <form action="{{ route('booking.jadwal', $booking->id_booking) }}" method="POST" style="display:inline;">
        @csrf
        <input type="hidden" name="aksi" value="konfirmasi">
        <button type="submit" class="btn blue">Jalankan Booking</button>
      </form>
    </div>
  </div>
</div>
