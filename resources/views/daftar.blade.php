...
<body class="bg-white flex items-center justify-center min-h-screen">
  <div class="w-full max-w-md px-8 py-10 shadow-md border rounded-md">
    ...
    <h2 class="text-2xl font-semibold text-center mb-2">Daftar</h2>
    <p class="text-center text-sm text-gray-600 mb-6">Input your username and password.</p>
    
    <form>
      <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-1">Username</label>
        <input type="text" placeholder="e.g. alifanchii" class="w-full border border-pink-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500"/>
      </div>
      <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-1">Username</label>
        <input type="text" placeholder="e.g. alifanchii" class="w-full border border-pink-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500"/>
      ...
      <div class="mb-6">
        ...
        <div class="relative">
          <input type="password" id="password" placeholder="e.g. 4kuBu7uhM3dkIt" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500"/>
    ...
    <p class="text-center text-sm mt-6">Already have an account?  
      <a href="{{ url('/') }}" class="text-pink-600 hover:underline">Login here!</a>
    </p>
